...
#release = '0.0.1'
release = find_version(repo_root, 'compfile', '__init__.py')
...
latex_documents = [
    (master_doc, 'compfile.tex', 'compfile Documentation',
     'Liyu Gong', 'manual'),
]
...
man_pages = [
    (master_doc, 'compfile', 'compfile Documentation',
     [author], 1)
]
...
texinfo_documents = [
    (master_doc, 'compfile', 'compfile Documentation',
     author, 'compfile', 'One line description of project.',
     'Miscellaneous'),
]
